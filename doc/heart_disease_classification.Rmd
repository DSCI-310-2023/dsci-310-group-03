...
```{r classificaion-plot, fig.cap = "Fitting of data with `exercise pain` and `age` as predictors", out.width = "80%"}

knitr::include_graphics(here("results/final_classification_plot.png"))s
```
