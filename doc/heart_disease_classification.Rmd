...
```{r ratio-plot, fig.show = "hold", out.width = "80%", out.height = "70%", fig.cap = "The proportion of different values in each factorial attribute"}
...
```{r var-hist, fig.cap = "The distribution of value of each attribute colored by diagnosis: *(a)* Serium Cholesterol; *(b)* Age; *(c)* Resting Blood Pressure; *(d)* Max Heart Rate; *(e)* Oldpeak; *(f)* Number of Colored Vessels", out.width = "80%"}
