...
```{r training-set}
training_set <- read_csv("../results/training_set.csv", show_col_types = FALSE)
knitr::kable(training_set, caption = "Training Set")
```
```{r testing-set}
testing_set <- read_csv("../results/testing_set.csv", show_col_types = FALSE)
knitr::kable(testing_set, caption = "Testing Set")
```
